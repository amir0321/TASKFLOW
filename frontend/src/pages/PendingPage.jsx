    ...
    return (
        <div className={layoutClasses.container}>
            <div className={layoutClasses.headerWrapper}>
                <div>
                    <h1 className='text-2xl md:text-3xl text-gray-800 flex items-center gap-2'>
            ...
            <div className={layoutClasses.addBox} onClick={() => setShowModal(true)}>
                ...
                transition-colors'>
                    <div className='w-8 h-8 bg-white flex items-center justify-center shadow-sm 
                ...
                {sortedPendingTasks.length === 0 ? (
                    ...
                    sortedPendingTasks.map(task => (
                        <TaskItem key={task._id || task.id}
                            task={task}
                            showCompleteCheckbox onDelete={() => handleDeleteTask(task._id || task.id)}
