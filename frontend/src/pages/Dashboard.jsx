...
import { WRAPPER, HEADER, ADD_BUTTON, STATS_GRID, STAT_CARD, STATS, ICON_WRAPPER, VALUE_CLASS, LABEL_CLASS, FILTER_LABELS, SELECT_CLASSES, FILTER_OPTIONS, TABS_WRAPPER, TAB_BASE, TAB_ACTIVE, TAB_INACTIVE, FILTER_WRAPPER, EMPTY_STATE } from '../assets/dummy';
            ...
            <div className={HEADER}>
                <div className='min-w-0'>
                    <h1 className="text-xl md:text-3xl font-bold text-gray-800 flex items-center gap-2">
                        <HomeIcon className='w-5 h-5 text-purple-500 md:h-6 md:w-6 shrink-0' />
                        ...
                        <div className='flex items-center gap-2 md:gap-3'>
                            ...
                            <div className='min-w-0'>
                                <p className={`${VALUE_CLASS} ${gradient ?
                                    'bg-gradient-to-br from-fuchsia-500 to-purple-600 bg-clip-text text-transparent'
            ...
            <div className='space-y-6'>
                ...
                <div className={FILTER_WRAPPER}>
                    ...
                    <select value={filter} onChange={(e) => setFilter(e.target.value)}
                        className={SELECT_CLASSES} id="task-filter-select" name="task-filter">
