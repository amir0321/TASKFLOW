...
const Navbar = ({ user = {}, onLogout }) => {
    ...
    return (
        <header className='sticky top-0 z-50 bg-white/50 backdrop-blur-md shadow-sm border-b border-gray-200 font-sans'>
            <div className='flex items-center justify-between px-4 py-3 md:px-6 max-w-7xl mx-auto'>
                ...
                <div
                    ...
                    to-indigo-500 bg-clip-text text-transparent tracking-wide ml-2'>
                        TaskFlow
                    </span>
                </div>
                        ...
                        {menuOpen && (
                            ...
                            shadow-xl border border-purple-100 z-50 overflow-hidden animate-fadeIn '>
                                ...
                                <li className=' p-2 '>
                                    ...
                                    items-center gap-2 rounded-lg px-3 py-2 text-sm hover:bg-red-50 text-red-500 '>
