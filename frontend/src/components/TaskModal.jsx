...
const TaskModal = ({ isOpen, onClose, taskToEdit, onSave, onLogout }) => {
    ...
    return (
        <div className='fixed inset-0 bg-black/20 backdrop-blur-sm flex z-50 items-center justify-center 
        p-4'>
            ...
            shadow-lg relative p-6 animate-fadeIn'>
                ...
                <form onSubmit={handleSubmit} className='space-y-4'>
                    {error && <div className='text-red-600 text-sm bg-red-50 p-3 rounded-lg 
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="3"
                            ...
                            className={baseControlClasses} placeholder='Add details about the task' />
                    </div>
