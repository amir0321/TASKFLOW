...
import { LINK_CLASSES, PRODUCTIVITY_CARD, SIDEBAR_CLASSES, TIP_CARD, menuItems } from '../assets/dummy'
        ...
        <ul className=' space-y-2'>
            {menuItems.map(({ text, path, icon }) => (
                <li key={text}>
                    ...
                    ].join(' ')} onClick={() => isMobile && setMobileOpen(false)}>
                    ...
                    <div className=' flex items-center gap-3'>
                        ...
                        <div>
                            ...
                            <p className=' text-sm text-purple-500 font-medium flex items-center gap-1'>
                                <Sparkles className='w-3 h-3' /> Let's get some tasks!
                            </p>
                        </div>
                    </div>
